...
begin
  _RAISE_STUB('—делать проверку истечени€ времени действи€ токена');
  {TODO: —делать проверку истечени€ времени действи€ токена}
end;
...
begin
  {TODO: ”брать отсюда OXML. ћне нужно несколько параметров из тела. ћожно самому распарсить}
  ...
  try
    ...
    {TODO: Ќадо разобратьс€ дл€ чего эта строка ^}
